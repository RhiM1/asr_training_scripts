...
python train_H.py --checkpoint '' \
    --checkpoint_dir './checkpoints/sc_ctc_lr1e-6_wd1e-4/' \
...
python train_H.py --checkpoint '' \
    --checkpoint_dir './checkpoints/sc_ctc_lr1e-5_wd1e-2/' \
    --model_config '../model_configs/conformer_sc_ctc_small.yaml' \
    --min_lr 1e-5 \
    --max_lr 3e-4 \
    --step_size 150 \
...
python train_H.py --checkpoint '' \
    --checkpoint_dir './checkpoints/sc_ctc_lr1e-6_wd1e-3/' \
    --model_config '../model_configs/conformer_sc_ctc_small.yaml' \
    --min_lr 1e-6 \
    --max_lr 3e-5 \
    --step_size 150 \
...
# python train_H.py --checkpoint '' \
#     --checkpoint_dir './checkpoints/sc_ctc_lr1e-6_wd1e-2/' \
#     --model_config './checkpoints/sc_ctc_lr1e-6_wd1e-2/conformer_sc_ctc_small.yaml' \
#     --min_lr 1e-6 \
#     --max_lr 3e-5 \
#     --step_size 150 \
#     --step_size 150 \
